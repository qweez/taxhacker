...
export const settingsFormSchema = z.object({
  ...
  xai_model_name: z.string().default("grok-3"),
  claude_code_path: z.string().default("claude"),
  claude_code_model: z.string().default("claude-opus-4-6"),
  mistral_api_key: z.string().optional(),
  mistral_model_name: z.string().default("mistral-medium-latest"),
  ollama_base_url: z.string().default("http://localhost:11434"),
  ollama_model_name: z.string().default("qwen2.5vl:7b"),
  llm_providers: z.string().default('claude-code,xai,anthropic,openai,google,mistral,ollama'),
