 ...
 * Vollständige Anbindung an ERPNext (Frappe Framework REST API)
 * für die Buchhaltungssynchronisation
 */
...
export class ERPNextClient {
   ...
   * Auth via Token-Header: Authorization: token api_key:api_secret
   */
